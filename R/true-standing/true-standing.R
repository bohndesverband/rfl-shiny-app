true_standing <- readr::read_csv(paste0("https://raw.githubusercontent.com/jak3sch/rfl/main/data/true-standing/rfl-true-standing-", var.seasonBeforeWeek2, ".csv"), col_types = "ncinnnnnnnnn") %>%
  dplyr::left_join(
    franchises %>%
